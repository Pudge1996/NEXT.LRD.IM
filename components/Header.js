...
import { IoMenu, IoLogoRss, IoPerson } from "react-icons/io5";
    ...
    <>
      <div className="bg-color transition-all border-b border-neutral-200 dark:border-neutral-900 sticky h-max top-0 z-[39] ">
        <div className="relative flex justify-between items-center max-w-2xl mx-auto px-5 md:px-3 h-[60px]">
          <Link
            href="/"
            title={t("common.information.site")}
            alt={t("common.information.site")}
            aria-label={t("common.information.site")}
          ...
          <div className="flex items-center gap-2 rtl:flex-row-reverse">
            ...
            >
              <span
                className={`${
                  router.pathname === "/blog" && "text-primary font-semibold"
                }`}
              >
            ...
            >
              <span
                className={`${
                  router.pathname === "/about" && "text-primary font-semibold"
                }`}
              >
            ...
            <div className="sm:hidden">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <Menu.Button className="btn-base btn-icon" title={t("common.header.mobileNavTitle")}>
