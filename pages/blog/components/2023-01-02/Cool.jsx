    ...
    <React.Fragment>
      ...
      >
        <div className="w-full h-[220px] img-loading-bg border border-neutral-200 dark:border-neutral-800 rounded-lg flex items-center @container">
          <div className="relative flex justify-between items-center mx-auto px-5 w-[85%] h-[60px] bg-color rounded ">
            ...
            <div className="flex gap-2 items-center">
              <div className="flex gap-2 items-center @[400px]:hidden">
                {headerNavLinks.map((link) => (
                  <div className="btn-base hover:text-primary btn-md text-tertiary cursor-pointer">
                    ...
                    <div className="p-2 w-40 w-max-48 flex flex-col">
                      {headerNavLinks.map((link) => (
                        <Menu.Item key={link.title}>
                          {({ active }) => (
                            <div
                              className={` btn-base btn-md px-3 py-4 cursor-pointer ${
                                active
