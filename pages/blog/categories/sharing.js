...
export default function cateSharing({ posts }) {
  return (
    <>
      <Head>
        <title>{blogCategoriesData[2].name} - 博客 - {siteMetadata.title}</title>
        ...
        <meta property="og:title" content={`${blogCategoriesData[2].name} - 博客 - ${siteMetadata.title}`} />
      ...
      <div className="layout series">
        {/* 博客列表 */}
        <h1>{blogCategoriesData[2].name}</h1>
        <p>{blogCategoriesData[2].desc}</p>
