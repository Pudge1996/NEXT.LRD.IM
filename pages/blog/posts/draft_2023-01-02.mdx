...
<figure><video width="100%" autoPlay loop="loop" muted alt="React Wrap Balancer 的效果预览动图。拖动手柄来改变容器宽度，观察使用该组件前后的效果对比。" src="https://lrdim.oss-cn-shenzhen.aliyuncs.com/blogimg/2023-01-02/05.mp4" /></figure>
