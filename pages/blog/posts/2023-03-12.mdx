...
![重构前后避免出现孤字的做法](https://lrdim.oss-cn-shenzhen.aliyuncs.com/blogimg/2023-03-12/04.png)
...
<figure><video width="100%" autoPlay loop="loop" muted alt="React Wrap Balancer 的效果预览动图。拖动手柄来改变容器宽度，观察使用该组件前后的效果对比。" src="https://lrdim.oss-cn-shenzhen.aliyuncs.com/blogimg/2023-03-12/05.mp4" /></figure>
...
![](https://lrdim.oss-cn-shenzhen.aliyuncs.com/blogimg/2023-03-12/06.png "图片来自 Tailwind CSS")
...
![图片组件的多种变量示意。](https://lrdim.oss-cn-shenzhen.aliyuncs.com/blogimg/2023-03-12/09.png)
...
![使用组件前后，源文件的对比。](https://lrdim.oss-cn-shenzhen.aliyuncs.com/blogimg/2023-03-12/10.png)
