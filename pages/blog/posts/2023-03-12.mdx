...
<figure><video width="100%" autoPlay loop="loop" muted alt="React Wrap Balancer 的效果预览动图。" src="https://lrdim.oss-cn-shenzhen.aliyuncs.com/blogimg/2023-03-12/05.mp4" /></figure>
